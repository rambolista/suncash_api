...
use App\Services\Tools\TransactionFeeService;
...
{
    protected const MODULE_PATH = '/tools/transaction-fees';

    public function __construct(private readonly TransactionFeeService $fees) {}
    ...
    public function update(Request $request, int $id): JsonResponse
    {
        ...
        return response()->json(['message' => 'Transaction fee has been updated.', 'data' => $fee]);
    }
}
