...
/** Adds the "Partner Settlement" tab (9th) to the Kiosk "Reports" tabbed page. */
return new class extends Migration
{
    public function up(): void
    {
        ...
        DB::table('menu_tabs')->updateOrInsert(
            ['menu_id' => $menuId, 'key' => 'partner_settlement'],
            [
        ...
        $tabId = DB::table('menu_tabs')->where('menu_id', $menuId)->where('key', 'partner_settlement')->value('id');
