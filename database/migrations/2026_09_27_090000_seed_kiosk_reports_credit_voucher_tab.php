...
/** Adds the "Credit Voucher" tab (12th, right after "Commission Approval") to the Kiosk "Reports" tabbed page. */
return new class extends Migration
{
    public function up(): void
    {
        ...
        DB::table('menu_tabs')->updateOrInsert(
            ['menu_id' => $menuId, 'key' => 'credit_voucher'],
            [
        ...
        $tabId = DB::table('menu_tabs')->where('menu_id', $menuId)->where('key', 'credit_voucher')->value('id');
