...
/** Adds the "Reconciliation" tab (6th) to the Kiosk "Reports" tabbed page. */
return new class extends Migration
{
    public function up(): void
    {
        ...
        DB::table('menu_tabs')->updateOrInsert(
            ['menu_id' => $menuId, 'key' => 'reconciliation'],
            [
        ...
        $tabId = DB::table('menu_tabs')->where('menu_id', $menuId)->where('key', 'reconciliation')->value('id');
