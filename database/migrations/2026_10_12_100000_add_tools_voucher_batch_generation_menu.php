 ...
 * the current last item (Compliance, sort_order 13).
 */
return new class extends Migration
{
    public function up(): void
    {
        ...
        $menuId = DB::table('menus')->insertGetId([
            'label' => 'Voucher Batch Generation',
            'slug' => 'pages:tools-voucher-batch-generation',
            'url' => '/tools/voucher-batch-generation',
            'icon' => 'ticket',
            'sort_order' => 14,
            'parent_id' => $toolsId,
            'is_title' => 0,
    ...
    {
        $menuId = DB::table('menus')->where('slug', 'pages:tools-voucher-batch-generation')->value('id');
