...
/** Adds the "Commission" tab (4th) to the Kiosk "Reports" tabbed page, alongside Zout/Replenish/Transaction. */
return new class extends Migration
{
    public function up(): void
    {
        ...
        $now = now();
        $tabId = DB::table('menu_tabs')->updateOrInsert(
            ['menu_id' => $menuId, 'key' => 'commission'],
            [
                'label' => 'Commission',
                'icon' => 'percentage',
                'sort_order' => 3,
        ...
        $tabId = DB::table('menu_tabs')->where('menu_id', $menuId)->where('key', 'commission')->value('id');
        ...
        // how the original three tabs were backfilled when they were introduced.
