...
/** Adds the "Agent Commission" tab (5th) to the Kiosk "Reports" tabbed page, alongside Zout/Replenish/Transaction/Commission. */
return new class extends Migration
{
    public function up(): void
    {
        ...
        DB::table('menu_tabs')->updateOrInsert(
            ['menu_id' => $menuId, 'key' => 'agent_commission'],
            [
        ...
        $tabId = DB::table('menu_tabs')->where('menu_id', $menuId)->where('key', 'agent_commission')->value('id');
