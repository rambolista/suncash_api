...
/** Adds the "Voucher Access" tab (10th, right after "Partner Settlement") to the Kiosk "Reports" tabbed page. */
return new class extends Migration
{
    public function up(): void
    {
        ...
        DB::table('menu_tabs')->updateOrInsert(
            ['menu_id' => $menuId, 'key' => 'voucher_access'],
            [
                'label' => 'Voucher Access',
                'icon' => 'ticket',
                'sort_order' => 9,
                'is_active' => 1,
                'supports_view' => 1,
        ...
        $tabId = DB::table('menu_tabs')->where('menu_id', $menuId)->where('key', 'voucher_access')->value('id');
        ...
        // how every previous tab was backfilled when it was introduced.
