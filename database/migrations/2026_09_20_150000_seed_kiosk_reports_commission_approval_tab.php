...
/** Adds the "Commission Approval" tab (11th, right after "Voucher Access") to the Kiosk "Reports" tabbed page. */
return new class extends Migration
{
    public function up(): void
    {
        ...
        DB::table('menu_tabs')->updateOrInsert(
            ['menu_id' => $menuId, 'key' => 'commission_approval'],
            [
        ...
        $tabId = DB::table('menu_tabs')->where('menu_id', $menuId)->where('key', 'commission_approval')->value('id');
